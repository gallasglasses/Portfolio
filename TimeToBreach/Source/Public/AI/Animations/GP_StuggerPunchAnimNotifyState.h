...
#include "GP_StuggerPunchAnimNotifyState.generated.h"

UCLASS()
class GP4_TEAM7_API UGP_StuggerPunchAnimNotifyState : public UAnimNotifyState
{
	GENERATED_BODY()
